 ...
 */
@ApiModel
public class GeneratorDataQueryWebVo extends Vo {
    ...
    private GeneratorDataQueryWebVo parent;
	...
	public GeneratorDataQueryWebVo() {
    ...
    public GeneratorDataQueryWebVo getParent() {
        return this.parent;
    }

	public void setParent(GeneratorDataQueryWebVo parent) {
        this.parent = parent;
    }
