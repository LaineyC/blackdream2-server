 ...
 */
@ApiModel
public class GeneratorDataSearchWebVo extends Vo {
    ...
    private GeneratorDataSearchWebVo parent;
	...
	public GeneratorDataSearchWebVo() {
    ...
    public GeneratorDataSearchWebVo getParent() {
        return this.parent;
    }

	public void setParent(GeneratorDataSearchWebVo parent) {
        this.parent = parent;
    }
